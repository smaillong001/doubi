...
ss_link_qr(){
	...
	SSurl="ss://${SSbase64}"
	SSQRcode="https://www.smaillong.com/qr/test.php?text=${SSurl}"
...
ssr_link_qr(){
	...
	SSRQRcode="https://www.smaillong.com/qr/test.php?text=${SSRurl}"
...
Set_config_method(){
 ...
 ${Green_font_prefix}17.${Font_color_suffix} aes-128-gcm
 ${Green_font_prefix}18.${Font_color_suffix} aes-192-gcm
 ${Green_font_prefix}19.${Font_color_suffix} aes-256-gcm
